        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold text-white tracking-tight">{firstWord}</span>
              <span className="text-2xl font-bold text-orange-400 tracking-tight">{restWords}</span>
            </div>
            <p className="text-emerald-100/80 text-sm leading-relaxed">
              Your premium destination for the finest local and international biscuits. Baking happiness since 2026.
            </p>
            <div className="flex space-x-4 pt-2">
              <a href={settings.facebookUrl} className="text-emerald-100 hover:text-orange-400 transition-colors"><Facebook className="w-5 h-5" /></a>
              <a href={settings.twitterUrl} className="text-emerald-100 hover:text-orange-400 transition-colors"><Twitter className="w-5 h-5" /></a>
              <a href={settings.instagramUrl} className="text-emerald-100 hover:text-orange-400 transition-colors"><Instagram className="w-5 h-5" /></a>
            </div>
          </div>
